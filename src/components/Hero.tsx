      ...
      <div className="section-container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            >
              Specialized SEO Services For <span className="text-dental-600">Dental Practices</span>
            </motion.h1>
            ...
            >
              Helping dental practices attract more patients with tailored SEO strategies that deliver measurable results.
            </motion.p>
            ...
            >
              ...
              <span>Specialized in dental SEO</span>
            </motion.div>
          </div>
          ...
          >
            <div className="bg-white rounded-lg shadow-xl p-6 md:p-8 relative z-10">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800">Average Results</h3>
                  <p className="text-gray-500">For our dental clients</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="bg-dental-50 rounded-lg p-4 text-center">
                  ...
                  <p className="text-sm text-gray-600">More new patient calls</p>
                </div>
                <div className="bg-dental-50 rounded-lg p-4 text-center">
                  <div className="text-3xl font-bold text-dental-600">83%</div>
                  <p className="text-sm text-gray-600">Better conversion rates</p>
                </div>
                <div className="bg-dental-50 rounded-lg p-4 text-center">
              ...
              <p className="text-sm text-center text-gray-500">Based on average performance across 50+ dental clients</p>
            </div>
